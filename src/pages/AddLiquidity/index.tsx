                                ...
                                <AutoColumn gap="20px">
                                    ...
                                    (isCreate ? (
                                        <ColumnCenter>
                                            <BlueCard>
                                                <AutoColumn gap="10px">
                                                    <TYPE.link fontWeight={600} color={'red'}>
                                                        WARNING: VulcanDEX protocol does not allow creation of new liquidity pools.
                                                    </TYPE.link>
                                                    <TYPE.link fontWeight={400} color={'primaryText1'}>
                                                        Only tokens chosen through VulcanDEX governance can be listed.
                                                    </TYPE.link>
                                                    <TYPE.link fontWeight={400} color={'primaryText1'}>
