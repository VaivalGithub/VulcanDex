...
import LockingDetails from './Farm/LockingDetails'
import withdrawl from './Farm/Token'



import PYRMATIC_P1 from './Farm/Pool1-PYRMATIC'
import PYRLAVA_P1 from './Farm/Pool1-PYRLAVA'
import PYRUSDC_P1 from './Farm/Pool1-PYRUSDC'
import PYRWETH_P1 from './Farm/Pool1-PYRWETH'


import Staking from './Staking'
import SyrupPools from './SyrupPools'
import Collectibles from './Collectibles'
import Swap from './Swap/index.tsx'
                    ...
                    <ContentArea id="ContentArea">
                        ...
                        <Web3ReactManager>
                            <Switch>
                               ...
                               <Route exact path="/LockingDetails/:pair/:pool/:lockingContractAddress/:LPTokenAddress" component={LockingDetails}/>
                               ...
                               <Route exact path="/FarmDetails-PYRLAVA" component={PYRLAVA_P1 }/>
                                <Route exact path="/FarmDetails-PYRUSDC" component={PYRUSDC_P1 }/>
                                <Route exact path="/FarmDetails-PYRWETH" component={PYRWETH_P1 }/>
