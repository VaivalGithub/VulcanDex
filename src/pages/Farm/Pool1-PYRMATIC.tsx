...
import { getPYRMATIC_P1_Contract, calculateGasMargin } from '../../utils'
...
const ConnectedFarmDetails = () => {
    const PYRMATIC_p1 = '0xE935430b53E0187b77479dAebfba956c199c8F67'//'0x7e79f8FD7F67e612B61bc2735fC4053B17360cF2'
    ...
    async function EndJoinDate_MATIC_P1_func() {
        ...
        if (formattedAmounts[Field.CURRENCY_B] != num) {
            ...
            const router = getPYRMATIC_P1_Contract(chainId, library, account)
                    ...
                    <div className={'row justify-content-between'}>
                        <div className={'col-sm-12 col-md-8 col-lg-8 col-xl-9 col-xxl-9'}>
                            <div className={'BorderBottom p-4'}>
                                <div className={'row'}>
                                    ...
                                    <div className={'col-xxl-3 col-xl-12 col-lg-12 col-md-12 mb-3 mt-4 mt-xxl-4 mb-xl-0'}>
                        ...
                        <div className={'col-sm-12 col-md-4 col-lg-4 col-xl-3 col-xxl-3'}>
                            <div className={'border-start border-color-grey pe-4 ps-5 py-4 text-center text-sm-start h-100'}>
                                ...
                                <p><a href={"https://polygonscan.com/address/0xA1746Cf26a0dc3272815d099156BcC2C2bAB40a2"} target="_blank" className={'OrangeColor text-decoration-on-hover'}>
                                    Get PYR-MATIC LP
                                ...
                                <p><a href={"https://polygonscan.com/address/0xA1746Cf26a0dc3272815d099156BcC2C2bAB40a2#readContract"} target="_blank" className={'OrangeColor text-decoration-on-hover'}>
                                    See Pair Info
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 24 24" fill="none" stroke="#EB7527"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
