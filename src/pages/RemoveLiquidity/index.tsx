        ...
        <>
            <div className="container-fluid h-100">
                <div className="row justify-content-center align-items-center h-100">
                    <div className="col-11 col-sm-9 col-md-8 col-lg-7 col-xl-6 col-xxl-4 py-5">
                        <AppBody>
                                ...
                                <AutoColumn gap="md">
                                    <BlueCard>
                                        <AutoColumn gap="10px">
                                            <TYPE.link fontWeight={400} color={'primaryText1'}>
                                                ...
                                                at the current
                                                rate, proportional to your share of the pool. Accrued fees are included in the
                                                amounts you receive.
                                            </TYPE.link>
                                        </AutoColumn>
                                    </BlueCard>
                                    <LightCard>
                                        <AutoColumn gap="20px">
                                            ...
                                            {!showDetailed && (
                                                <>
                                                    <Slider value={innerLiquidityPercentage}
